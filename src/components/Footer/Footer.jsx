  ...
  return (
    <footer className="bg-[#afd1f3] text-black py-8 border-t border-gray-400 mt-10">
      <div className="max-w-[1300px] mx-auto px-2 ">
        <div className="mx-0 md:mx-4 lg:mx-0"><div className="flex flex-col md:flex-row justify-between items-center">
          {/* Brand */}
          <div className="mb-6 md:mb-0 flex">
            <img className="w-9 " src="https://i.ibb.co/kpFnqYQ/image.png" alt="brandLogo" />
